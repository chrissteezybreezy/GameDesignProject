...
namespace SurvivalEngine
{
    ...
    public class Destructible : MonoBehaviour
    {
        ...
        [Header("Loot")]
        public int xp = 0;
        public CraftData[] loots; //Assign single loots
        public CraftDataValue[] loots_quantity; //Assign loot with quantity
        public CraftDataRandom[] loots_random; //Assign loot with probability
        ...
        {
            foreach (CraftDataValue item in loots_quantity)
            {
                SpawnLoot(item.item, item.quantity);
            }
            ...
            foreach (CraftDataRandom loot in loots_random)
            {
